...
import com.pitchbooking.app.service.PendingBookingCache;
        ...
        try {
            ...
            try {
                emailService.sendBookingConfirmationEmail(
                        data.getUserEmail(), booking.getBookingCode(), booking.getId());
            } catch (Exception e) {
                log.warn("Gửi email xác nhận thất bại cho {}: {}", data.getUserEmail(), e.getMessage());
            }
            return ResponseEntity.ok(ApiResponse.<Map<String, Object>>builder()

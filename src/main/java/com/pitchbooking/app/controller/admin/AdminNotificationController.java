...
/**
 * Mirror of the client notification endpoints, scoped to the admin/staff caller.
 * Same persistence model — each admin sees only the notifications addressed to
 * their user ID. Bell badge polls /unread-count.
 */
@RestController

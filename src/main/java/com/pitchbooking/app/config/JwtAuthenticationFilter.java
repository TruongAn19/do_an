...
import com.pitchbooking.app.controller.AuthController;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    /**
     * FIX-S1: prefer the httpOnly cookie (browser flow) and fall back to the
     * Authorization header (server-to-server, Postman, mobile clients).
     */

                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach var="cartDetail" items="${cartDetails}" varStatus="status">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="mb-0 mt-4">
                                                        <fmt:formatNumber type="number" value="${cartDetail.product.sale}" />%
                                                    </p>
                                                </td>
                                                <td>
                                                    <div class="input-group quantity mt-4" style="width: 100px;">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            data-cart-detail-sale="${cartDetail.product.sale}"
                                                ...
                                                <td>
                                                    <p class="mb-0 mt-4" data-cart-detail-id="${cartDetail.id}">
                                                        <fmt:formatNumber type="number"
                                                            value="${cartDetail.price * cartDetail.quantity - (cartDetail.price * cartDetail.quantity * cartDetail.product.sale / 100)}" /> đ
                                                    </p>
                                                </td>
                                                <td>
